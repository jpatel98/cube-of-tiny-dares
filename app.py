...
def _generation_status(generation: dict[str, Any]) -> str:
    if generation.get("provider") == "modal":
        return "_Generated by Modal + Cohere._"
    return "_Local fallback._"
...
def gradio_tap(
...
) -> tuple[str, str, list[str], str, Any]:
    recent = recent or []
    ...
    return (
        ...
        gr.update(value=_generation_status(payload["generation"]), visible=True),
    )
...
def build_demo() -> gr.Blocks:
    with gr.Blocks(title=APP_TITLE) as demo:
        ...
        tap.click(
            ...
            outputs=[output, cube, recent_state, recent_display, source_status],
            api_name="tap",
        )
